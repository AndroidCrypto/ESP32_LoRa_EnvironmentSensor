...
//const long TRANSMISSION_INTERVAL_MILLIS = 20000; // transmission each 20 seconds
const long TRANSMISSION_INTERVAL_MILLIS = 120000;  // transmission each 120 seconds = 2 minutes
const long DISPLAY_UPDATE_INTERVAL_MILLIS = 1000;  // milliseconds for next update
